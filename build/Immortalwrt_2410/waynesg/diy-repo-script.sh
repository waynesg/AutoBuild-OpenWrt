...
#tailscale
clone_or_update_git_repo https://github.com/BootLoopLover/pakalolo-package/tree/master/applications package/waynesg/luci-app-tailscale "" luci-app-tailscale
#lucky
