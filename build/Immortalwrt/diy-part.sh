...
sed -i 's/"Argon 主题设置"/"主题设置"/g' package/waynesg/luci-theme-argon/luci-app-argon-config/po/zh_Hans/argon-config.po

#Argon主题修改
sed -i 's/(<%= ver.luciversion %>)//g' package/waynesg/luci-theme-argon/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
sed -i 's/<%= ver.distversion %>/Compiled By @waynesg/g' package/waynesg/luci-theme-argon/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
echo "重命名服务菜单"
