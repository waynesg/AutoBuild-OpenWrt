...
find . -name 'luci-app-qbittorrent' -o -name 'luci-app-unblockmusic' -o -name 'luci-app-pushbot' -o -name 'msd_lite' -o -name 'pdnsd-alt' -o -name 'v2ray-geodata' | xargs -i rm -rf {}
}
################################################################################################################
# LIENOL源码通用diy.sh文件
################################################################################################################
