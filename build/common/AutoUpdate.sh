...
export Author="${Apidz%/*}"
export CangKu="${Apidz##*/}"
Update_Tag="${Update_Tag:-AutoUpdate}"
export Github_Tags="https://api.github.com/repos/${Apidz}/releases/tags/${Update_Tag}"
export Github_Tagstwo="${Github}/releases/download/${Update_Tag}/Github_Tags"
export Kernel="$(egrep -o "[0-9]+\.[0-9]+\.[0-9]+" /usr/lib/opkg/info/kernel.control 2>/dev/null)"
[ -z "${Kernel}" ] && export Kernel="$(uname -r | egrep -o "[0-9]+\.[0-9]+\.[0-9]+")"
