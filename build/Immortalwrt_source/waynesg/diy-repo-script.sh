...
#uugame
git clone --depth=1 https://github.com/kiddin9/luci-app-uugamebooster package/waynesg/luci-app-uugamebooster
clone_or_update_git_repo https://github.com/kiddin9/openwrt-packages package/waynesg/uugamebooster "" uugamebooster
