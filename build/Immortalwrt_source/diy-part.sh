...
#sed -i 's/"Cloudflare 零信任隧道"/"Cloudflare 隧道"/g' feeds/luci/applications/luci-app-cloudflared/po/zh_Hans/cloudflared.po
...
sed -i 's/"Tailscale"/"Tailscale服务器"/g' package/waynesg/luci-app-tailscale/root/usr/share/luci/menu.d/luci-app-tailscale.json
TIME b "重命名 完成"
