...
echo "重命名网络菜单"
#network
sed -i 's/"IP\/MAC 绑定"/"地址绑定"/g' feeds/other/lean/luci-app-arpbind/po/zh-cn/arpbind.po
...
sed -i 's/"FTP 服务器"/"FTP 服务"/g' feeds/other/lean/luci-app-vsftpd/po/zh-cn/vsftpd.po
sed -i 's/"Alist 文件列表"/"Alist列表"/g' package/waynesg/luci-app-alist/luci-app-alist/po/zh-cn/alist.po
#vpn
sed -i 's/"ZeroTier"/"ZeroTier虚拟网络"/g' feeds/other/lean/luci-app-zerotier/luasrc/controller/zerotier.lua
TIME b "重命名 完成"
echo
TIME b "自定义文件修复权限"
